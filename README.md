...
Struct/1K           140µs ± 1%    75µs ± 1%  -46.46%  (p=0.000 n=10+10)
...
```
name               std time/op  new time/op  delta
Int/Small-1K       34.5µs ± 1%  16.0µs ± 5%  -53.59%  (p=0.000 n=9+10)
Int/Small-10K       583µs ± 0%   236µs ± 1%  -59.48%  (p=0.000 n=10+10)
Int/Small-100K     8.40ms ± 0%  3.23ms ± 0%  -61.54%  (p=0.000 n=9+10)
Int/Small-1M        110ms ± 0%    41ms ± 0%  -62.82%  (p=0.000 n=10+9)
Int/Random-1K      86.3µs ± 0%  37.1µs ± 2%  -56.95%  (p=0.000 n=10+9)
Int/Random-10K     1.10ms ± 0%  0.45ms ± 0%  -58.99%  (p=0.000 n=9+10)
Int/Random-100K    13.6ms ± 0%   5.4ms ± 0%  -60.39%  (p=0.000 n=9+9)
Int/Random-1M       162ms ± 0%    62ms ± 0%  -61.45%  (p=0.000 n=10+10)
Int/Constant-1K    5.71µs ± 0%  1.33µs ± 2%  -76.68%  (p=0.000 n=10+10)
Int/Constant-10K   33.0µs ± 0%   9.9µs ± 5%  -70.15%  (p=0.000 n=10+10)
Int/Constant-100K   252µs ± 0%    81µs ± 3%  -67.92%  (p=0.000 n=9+10)
Int/Constant-1M    2.47ms ± 1%  0.78ms ± 1%  -68.48%  (p=0.000 n=10+10)
Int/Descent-1K     7.90µs ± 0%  2.88µs ± 2%  -63.54%  (p=0.000 n=9+10)
Int/Descent-10K    42.0µs ± 1%  21.1µs ± 5%  -49.81%  (p=0.000 n=10+10)
Int/Descent-100K    366µs ± 0%   184µs ± 2%  -49.78%  (p=0.000 n=10+10)
Int/Descent-1M     3.62ms ± 1%  1.85ms ± 1%  -48.82%  (p=0.000 n=10+10)
Int/Ascent-1K      5.71µs ± 0%  1.82µs ± 2%  -68.06%  (p=0.000 n=8+10)
Int/Ascent-10K     32.5µs ± 1%  13.2µs ± 5%  -59.39%  (p=0.000 n=10+10)
Int/Ascent-100K     252µs ± 0%   110µs ± 3%  -56.48%  (p=0.000 n=10+10)
Int/Ascent-1M      2.47ms ± 1%  1.10ms ± 1%  -55.56%  (p=0.000 n=10+10)
Int/Mixed-1K       44.9µs ± 1%  21.2µs ± 3%  -52.91%  (p=0.000 n=10+10)
Int/Mixed-10K       532µs ± 0%   260µs ± 1%  -51.16%  (p=0.000 n=10+10)
Int/Mixed-100K     6.41ms ± 0%  2.96ms ± 0%  -53.86%  (p=0.000 n=9+10)
Int/Mixed-1M       76.1ms ± 0%  34.0ms ± 0%  -55.33%  (p=0.000 n=10+10)
Float/1K           99.4µs ± 0%  39.5µs ± 1%  -60.22%  (p=0.000 n=10+10)
Float/10K          1.28ms ± 0%  0.47ms ± 0%  -63.27%  (p=0.000 n=10+10)
Float/100K         15.8ms ± 0%   5.5ms ± 0%  -65.03%  (p=0.000 n=10+9)
Float/1M            188ms ± 0%    64ms ± 0%  -66.13%  (p=0.000 n=8+10)
Str/1K              139µs ± 0%    99µs ± 0%  -28.94%  (p=0.000 n=10+10)
Str/10K            1.83ms ± 0%  1.35ms ± 0%  -26.34%  (p=0.000 n=10+10)
Str/100K           23.9ms ± 0%  18.0ms ± 0%  -24.57%  (p=0.000 n=10+10)
Str/1M              325ms ± 1%   238ms ± 3%  -26.77%  (p=0.000 n=9+10)
Struct/1K           143µs ± 0%    75µs ± 1%  -47.50%  (p=0.000 n=10+10)
Struct/10K         1.79ms ± 0%  1.16ms ± 0%  -35.15%  (p=0.000 n=9+10)
Struct/100K        21.9ms ± 0%  14.0ms ± 1%  -35.86%  (p=0.000 n=10+10)
Struct/1M           262ms ± 0%   167ms ± 1%  -36.20%  (p=0.000 n=9+9)
Stable/1K           500µs ± 1%    86µs ± 1%  -82.74%  (p=0.000 n=10+10)
Stable/10K         8.32ms ± 1%  1.38ms ± 1%  -83.39%  (p=0.000 n=10+10)
Stable/100K         132ms ± 0%    17ms ± 1%  -87.14%  (p=0.000 n=10+10)
Stable/1M           1.91s ± 0%   0.21s ± 1%  -89.23%  (p=0.000 n=10+10)
Pointer/1K         95.4µs ± 0%  66.5µs ± 1%  -30.33%  (p=0.000 n=10+9)
Pointer/10K        1.29ms ± 0%  0.93ms ± 0%  -27.73%  (p=0.000 n=10+9)
Pointer/100K       17.6ms ± 0%  13.1ms ± 1%  -25.65%  (p=0.000 n=9+10)
Pointer/1M          266ms ± 7%   204ms ± 3%  -23.11%  (p=0.000 n=10+10)
```
